...
addEventHandler("onClientRender", root, function()
	...
	--
	if ( shaderSettings.blurFactor > 1 ) then
		currentBox = applyBlurH( currentBox, scx, scy, 1 )
		currentBox = applyBlurV( currentBox, scx, scy, 1 )
	end
	--
	dxSetRenderTarget()
	boxTable.thisBox = 0
...
,true ,"high" .. shaderSettings.orderPriority )
